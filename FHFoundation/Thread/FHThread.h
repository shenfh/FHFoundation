 ...
 */
extern void runInMain(FHThreadBlock block );
 ...
 */
extern void runAsyn(FHThreadBlock block,FHQueueLevel level);

/**
 线程队列
 */
extern dispatch_queue_t ququeWithLevel(FHQueueLevel level);
